#
# Be sure to run `pod lib lint UIBezierPathOvalSegment.podspec' to ensure this is a
...
Pod::Spec.new do |s|
  s.name             = "UIBezierPathOvalSegment"
  s.version          = "0.1.0"
  s.summary          = "A short description of UIBezierPathOvalSegment."
...
#   * Finally, don't worry about the indent, CocoaPods strips it!  
  ...
  s.resource_bundles = {
    'UIBezierPathOvalSegment' => ['Pod/Assets/*.png']
  }
